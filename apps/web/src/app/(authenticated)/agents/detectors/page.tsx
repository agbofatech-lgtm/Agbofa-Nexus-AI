...
const INITIAL_8_DETECTORS: DetectorAgentItem[] = [
  ...
  },
  {
    ...
    version: "1.0.0",
    uptime: 99.98,
    lastCheckedAt: new Date(Date.now() - 8 * 60000).toISOString(),
    detections24h: 890,
    avgConfidence: 0.94,
    avgLatencyMs: 135,
  ...
  },
  {
    ...
    version: "1.0.0",
    uptime: 99.97,
    lastCheckedAt: new Date(Date.now() - 12 * 60000).toISOString(),
    detections24h: 2150,
    avgConfidence: 0.95,
    avgLatencyMs: 85,
  ...
  },
  {
    ...
    version: "1.0.0",
    uptime: 100.0,
    lastCheckedAt: new Date(Date.now() - 18 * 60000).toISOString(),
    detections24h: 1420,
    avgConfidence: 0.98,
    avgLatencyMs: 92,
  ...
  },
  {
    ...
    version: "1.0.0",
    uptime: 99.99,
    lastCheckedAt: new Date(Date.now() - 32 * 60000).toISOString(),
    detections24h: 1840,
    avgConfidence: 0.99,
    avgLatencyMs: 45,
  ...
  },
  {
    ...
    version: "1.0.0",
    uptime: 99.95,
    lastCheckedAt: new Date(Date.now() - 48 * 60000).toISOString(),
    detections24h: 680,
    avgConfidence: 0.92,
    avgLatencyMs: 165,
