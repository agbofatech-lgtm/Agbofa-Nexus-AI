...
// IdentityLookup extends the identity store with token-refresh lookups.
type IdentityLookup interface {
FindUserByID(ctx context.Context, userID string) (*domain.User, error)
ConsumeRefreshToken(ctx context.Context, refreshToken string) (userID, tenantID string, ok bool)
}
