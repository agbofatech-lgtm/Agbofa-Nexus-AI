...
| Planning Review CARD-IMP-009 | Planning review | CARD-IMP-009 Story Graph & Knowledge Intelligence | Draft Implementation Cards | Accepted for Planning; card remains Draft | Dependency/governance validation | Yes | Pending current commit | Pass | Draft — Not Approved |
