...
| Planning Review CARD-IMP-011 | Planning review | CARD-IMP-011 Compliance Gatekeeper | Draft Implementation Cards | Accepted for Planning; card remains Draft | Dependency/governance validation | Yes | Pending current commit | Pass | Draft — Not Approved |
