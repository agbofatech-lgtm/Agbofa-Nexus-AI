...
| Planning Review CARD-IMP-014 | Planning review | CARD-IMP-014 Frontend Foundation | Draft Implementation Cards | Accepted for Planning; card remains Draft | Dependency/governance validation | Yes | Pending current commit | Pass | Draft — Not Approved |
