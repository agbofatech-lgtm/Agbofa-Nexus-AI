...
| Planning Review CARD-IMP-010 | Planning review | CARD-IMP-010 Content Factory | Draft Implementation Cards | Accepted for Planning; card remains Draft | Dependency/governance validation | Yes | Pending current commit | Pass | Draft — Not Approved |
