...
| RISK-0008 | Manual governance enforcement does not scale | Human-only review may miss drift, orphan contracts, invalid references, or registry inconsistencies. | Reduced reliability during long implementation. | Automated validators, JSON registries, documentation pipeline checks, and CI enforcement. | Enterprise Engineering Agent | Mitigated by automation |
