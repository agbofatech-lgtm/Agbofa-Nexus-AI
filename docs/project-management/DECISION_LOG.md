...
| 2026-08-07 | DEC-0008 | Shift from additional governance documents to automated governance enforcement. | Governance maturity is sufficient; long-term scalability requires validators, machine-readable registries, documentation pipeline checks, retrieval directories, and CI enforcement. | Repository automation | User instruction | governance/validators/, docs/indexes/json/, scripts/, .github/workflows/ | Active |
